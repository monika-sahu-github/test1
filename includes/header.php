...
/*  content: counter(flag);
  ...
  /*background: linear-gradient(#444, #222);*/
    ...
    /*  background: linear-gradient(#f93, #48467600);*/
   ...
   <!--    </li>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" id="notification" >
          ...
          <?php  $verify = "SELECT verify_status from examinee_tbl WHERE exmne_id = $examnee_id";
            ...
            if($verify_status == 0){
              $count = $count + 1;
              echo "<div style='background-color:#fffff;'><span class='dropdown-item notifi'>Verify your email id go to: &nbsp;<a href='home.php?page=myprofile'> My Account</a></span></div>";

            }else{ 
              // echo "<div style='background-color:#30f91069;'><span class='dropdown-item notifi'>verification has done</span> </div>";
               } } ?>
          ...
          <?php
            ...
            if($payment_status == 0){
              ...
              //echo "<div style='background-color:#30f91069;'><span class='dropdown-item notifi'>payment has done</span> </div>";
               } ?>
      ...
      ?>
         ...
         <span class="badge badge-warning navbar-badge" style="font-size: 30px;">
           ...
           <?php if ($count != 0){ echo $count; ?> </span><?php }else {} ?> 
