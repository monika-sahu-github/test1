...
$key, $options, $iv); 
 ?><div class="app-sidebar sidebar-shadow">
  ...
  <li class="app-sidebar__heading">Exam</li>
                ...
                <ul >
                    <li>
                      <a href="home.php?page=examination_test_type&exam_type=<?php echo $encryption; ?>&source=menu"> 
                                <i class="metismenu-icon"></i>Practice Test
                            </a>
                       </li>

                    <li>
                      <a href="home.php?page=mock&source=menu"> 
         ...
         <li class="app-sidebar__heading">RESULT</li>
                ...
                <ul>
                       ...
                       <li>
                      <a href="home.php?page=all_results&source=menu"> 
                                <i class="metismenu-icon"></i>Practice Test Result
                            </a>
                       </li>
                      <li>
                      <a href="home.php?page=mock_result&source=menu"> 
