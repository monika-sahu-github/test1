...
?><p  onclick="return set_option('<?php echo $eqt_id; ?>','<?php echo $i; ?>','<?php echo $num3; ?>');" style="cursor: pointer;<?php if($selected_ans==$exam_chArr['id']){ ?>background: rgb(242, 249, 255);border: 1px solid rgb(212, 223, 232); <?php }  ?>" id="pt<?php echo $i; ?>"><input id='op<?php echo $i; ?>' type="radio" style="cursor: pointer;" onclick="return set_option('<?php echo $i; ?>');" <?php if($selected_ans==$exam_chArr['id']){ echo $selected; }  ?> name="answers" required="" value="<?php echo htmlspecialchars_decode($exam_chArr['id']); ?>" >(<?php echo $x; ?>) <?php echo htmlspecialchars_decode($exam_chArr['answer']); ?></p>
<?php $numm++; $x++; $i++;} ?>
