     ...
     <div class="modal-content">
        ...
        <div class="col-md-12">
          <div class="form-group">
            <label>Exam Type</label>
             <select name="exam_type" required="" id="exam_type" class="form-control">
               <option value="">Select Exam Type</option>
               <option selected="" value="0">Practice Test</option>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Subject</label>
            <input type="text" name="course_name" id="course_namea" class="form-control" placeholder="Input Subject" required="" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Subject Caption</label>
            <input type="text" name="exam_logo" id="exam_logo" class="form-control" placeholder="Subject Caption" required="" autocomplete="off">
          </div>
        </div>
      </div>
...
<!---------Model For MockTEst------------------------>
<div class="modal fade" id="modalForAddMockTest" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="AddMockTestFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">MOCK TEST</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" name="exam_name" id="exam_name" class="form-control" placeholder="Enter Exam Name" required="" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Exam Caption</label>
            <input type="text" name="exam_mock_logo" id="exam_mock_logo" class="form-control" placeholder="Enter Exam Caption" required="" autocomplete="off">
          </div>
        </div>
      </div>
            <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="number" name="questions" id="questions" class="form-control" required="" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="datetime-local" name="exam_datetime" id="exam_datetime" class="form-control" required="" autocomplete="off">
          </div>
        </div>
      </div>
      <div class="modal-footer">
...
<div class="modal fade myModal" id="updateCourse-<?php echo $selCourseRow['cou_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog " role="document">
     <form class="refreshFrm" id="addCourseFrmUPdate" method="post" >
...
<div class="modal fade" id="modalForExam" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addExamFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Subject Topic</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            <label>Exam Type</label>
             <select name="exam_typee" required="" id="exam_typee" class="form-control">
               <option value="">Select Exam Type</option>
      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select class="form-control" required="" id="courseSelected" name="courseSelected">
              ...
              <?php 
                ...
                if($selCourse->rowCount() > 0)
                {
                  while ($selCourseRow = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                     <option value="<?php echo $selCourseRow['ex_id']; ?>"><?php echo $selCourseRow['ex_title']; ?></option>
                  <?php }
                }
                else
                { ?>
          ...
          <div class="form-group">
            ...
            <input type="datetime-local" name="examQuestTime" id="examQuestTime" class="form-control" placeholder="">
          </div>
...
<div class="modal fade" id="modalForAddQuestion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
   <form class="refreshFrm" id="addQuestionFrm" method="post">
     <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Question for <br><?php echo $selExamRow['quehead']; ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
