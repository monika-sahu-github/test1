                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            ...
                            <tbody>
                              <?php 
                                $selExmne = $conn->query("SELECT * FROM examinee_tbl et INNER JOIN exam_answers ea ON et.exmne_id = ea.exam_id ORDER BY ea.exam_id DESC ");
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                             <?php 
                                                ...
                                                $selExName = $conn->query("SELECT * FROM subject_quehead sq INNER JOIN exam_answers ea ON sq.exam_id=ea.exam_id WHERE  ea.exmne_id='$eid' ")->fetch(PDO::FETCH_ASSOC);
