...
window.location.href='home.php?page=tag';
</script>";
   }
    else {
...
<!-- dribbble -->
      ...
      <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="example" >
                            ...
                            <tr>
                                ...
                                <td class="test-left"><b>Update</b></td>
                                <td class="test-left"><b>Delete</b></td>
                            </tr>
                            </thead>
                            <tbody>
                              <?php 
                                    ...
                                    while ($row = $selCourse->fetch(PDO::FETCH_ASSOC)) { ?>
                                        <tr>
                                            <td class="pl-4">
                                              ...
                                              <a href="home.php?page=tag&id=<?php echo $row['id']; ?>" type="button" class="btn btn-primary">Edit</a>
                                             
                                            </td>
                                            <td class="text-left">
                                             <button class="btn btn-danger" onclick="delete_tags('<?php echo $row['id']; ?>');" style="color: white;" >Delete</button>
                                            </td>
                                        </tr>
                                      <?php } }else
                                { ?>
