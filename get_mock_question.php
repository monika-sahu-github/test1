...
if($chk_num==0){
$sql = "INSERT INTO `exam_answers`(`axmne_id`,`exam_id`, `quest_id`, `exam_answer_id`,`ans_explatnaion`, `answer_status`, `exans_created`,`is_mock`,`mock_type`) VALUES ('$examne_id','$exam_id','$queheadidd','$answer','$answers','','$cur_date','1','scheduled')"; 
$conn->query($sql);
 }
$implode .= ",".$queheadidd;
$nn = $i%6;
...
<center style="color: white;" ><?php echo $i; ?><div title="<?php echo $quehead; ?>" ></div></center></div> </span><?php //if($i==0){?></br><?php //}   ?>
<?php $i++; } ?></div>
        </div>
    </div><?php } 
    echo "|||".$implode;
