...
$answer_status = 3;
 ...
 echo $sql33 = "update exam_answers set exam_answer_id = '$answer', answer_status = '$answer_status', exans_created = '$cur_date' where sub_subjecthead_id='$queheadid' and axmne_id = '$examne_id' and quest_id = '$eqt_id' and YEAR(exans_created)='$y' and MONTH(exans_created)='$m' and DAY(exans_created)='$d' and exam_session = '$exam_session'";
...
Hide" id="kkk"  class="slide-toggle btn btn-warning kkk qtip tip-top"><b>>></b></button>
...
</div><br><b>OK <?php //echo $_REQUEST["que_numm"]; ?><b></div>
...
<div class="box-innerss" id="fflgdiv" style="height: 400px;
    overflow-x: scroll;">
