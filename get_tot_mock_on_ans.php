<?php
 ...
 session_start();
    ...
    $tot_skip = getvalfield($conn,"exam_answers","count(*)","axmne_id = '$examne_id' and exam_id = '$examId' and mock_type = 'on_demand' and answer_status = 2 and YEAR(exans_created)='$y' and is_finel_sub = 0");
    ...
    $tot_not_att = getvalfield($conn,"exam_answers","count(*)","axmne_id = '$examne_id' and exam_id = '$examId' and (answer_status = 3 OR answer_status = 0) and is_finel_sub = 0 and mock_type = 'on_demand'");
    $tot_not_att = $tot_not_att+$tot_skip;
    
    $tot_att = getvalfield($conn,"exam_answers","count(*)","axmne_id = '$examne_id' and exam_id = '$examId' and answer_status = 1 and is_finel_sub = 0 and mock_type = 'on_demand'");
