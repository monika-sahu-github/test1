        ...
        <!--     <div class="app-page-title">
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                     ...
                     <div class="responseTime" style="display: none;"></div>
...
<div class="col-sm-12">
 ...
 <div class="col-md-12 col-xl-12" style="padding-top: 15px;padding-bottom: 20px;">
    ...
    // //$match_max_que_id = $cmn->getvalfield($conn,"exam_que_for_match_tbl","max(que_id)","sub_id='$queheadid' and examinee_id = '$examne_id' and is_finel_sub = 1");
    // $max_que_id = $cmn->getvalfield($conn,"exam_question_tbl","max(eqt_id)","sub_subjecthead_id='$queheadid'");
    // //if($match_max_que_id==$max_que_id){
    // if(($match_max_que_id==$max_que_id) || ($match_max_que_id!="")){
    //  $num2 = $result2->rowCount();
    // } else {
    // $num2 = $matchtbl_countque = $cmn->getvalfield($conn,"exam_question_tbl","count(*)","eqt_id>'$match_max_que_id'");
    // }
    //$num2 = $matchtbl_countque = $cmn->getvalfield($conn,"exam_question_tbl","count(*)","eqt_id>'$match_max_que_id'");
    // $num2;
    ...
    //  $num2 = $result2->rowCount();
    // } else {
    // $num2 = $cmn->getvalfield($conn,"exam_question_tbl","count(*)","sub_subjecthead_id='$queheadid' and eqt_id>'$match_max_que_id'");
    // }
...
$result3 = $conn->query($sql_dhiraj);
    ...
    <input type="text" readonly="" name="examtime" id="examtime" > 
       ...
       </div><div class="col-sm-2"><a href="home.php" class="btn btn-danger qtip tip-top" data-tip="Quit Test" id="leavnow">Quit Test</a> </div></div><br>
           <!-- <div style="    width: 50%;
    background: #f7b924;
    border-radius: 3px;
...
<div style="width: 50%;
    ...
    font-weight: 700;
    padding: 4px;
    border: 1px solid #90939c;"  id="noquesel">

     <label><b>Select No. of Questions
      <form class="boxed">
    <?php if($num2>=5){ ?> 
      ...
      <input type="radio" name="timebond" id="timebond1" checked="" value="1"><label for="timebond1">Yes</label> <input type="radio" name="timebond" id="timebond2" value="0"> <label for="timebond2">No</label>
        ...
        <br> 
            <div class="row" id="start_button" >
                ...
                if($verify_status == 0){?>
                        <input id="duplicate" class="btn btn-success" type="button" name="start_exam" value="Start Exam" ><?php } else{ ?>
                        <input id="start_exam" class="btn btn-success" type="button" name="start_exam" value="Start Exam" ><?php }//}?></div>
                    </div>
              <div class="row">
...
// document.getElementById("ans_fix_time").value = mm + ":" + ss;
 ...
 //window.close();
  clearInterval(ssee);
  examtimeend();
  // document.getElementById('thanking').style.display = "none";
  // document.getElementById('show_time_marks').style.display = "none";
  // document.getElementById('question_area').style.display = "none";
  //  document.getElementById("thank_msgg").style.display = "none";
  //  document.getElementById("thank_msgg2").style.display = "none";
  //  document.getElementById('schedul_not_div').style.display = "block";
...
function showdiv(k){
    ...
    //document.getElementsByClassName("kkk").style.fontWeight = "900";
    if(k % 2 == 0) {
    //document.getElementsByClassName('kkk').innerHTML = '>>';
    //document.getElementsByClassName('kkk').setAttribute('data-tip', 'Hide');
    $(".toggle_btn").php(">>");
 ...
 $(".showmark").css("display", "block");
      ...
      $(".toggle_btn").php("<<");
      //document.getElementsByClassName('kkk').setAttribute('data-tip', 'Show');
     $(".toggle_btn").attr('data-tip', 'Show');
   // $("#kkk").style.right = null;
     //document.getElementsByClassName('showmark').style.display='none';
...
<script type="text/javascript">
                        ...
                        { 
                          ...
                          document.getElementById('pt1').style.border='white';
                          document.getElementById('pt3').style.border='white';
                           } //get_question(n,que_no,'selected','pointer'); }
