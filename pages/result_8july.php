    ...
    <div style="background: white;border: 3px solid #375176;padding: 0px;">
       ...
       <div class="row col-md-12 mb-3">
        ...
        <div class="row" >
                    ...
                    <div class="widget-content-right">
                        ...
                        <div class="widget-numbers">
                           ...
                           <?php
                            ...
                            ?><div class="row mb-3"><div class="col-md-1"></div>
                            <div class="col-md-5 card widget-content" style="padding: 0.1rem !important;     border: 1px solid #90939c; align-content: center;">
                            <span><h5 style="text-align: center;"><b>Score &nbsp;
                                <?php echo "( ","$ans"; echo "%"," )"; ?>
                                <?php echo $score; ?>/ <?php echo $over,"&nbsp;&nbsp;"; ?></b></h5></span></div>
                                <div class="col-md-5 card widget-content" style="padding: 0.1rem !important;     border: 1px solid #90939c; align-content: center;">                           
                                <span><h5><b> Total Time Duration  - <?php echo $examtime; ?>
                            </b></h5></span> </div>
            ...
            <div class="card mb-3 widget-content <?php if($total > 0){?>change<?php }else{}?>"
            ...
            <div class="card mb-3 widget-content <?php if($value > 0){?>change<?php }else{}?>">
            ...
            <div class="card mb-3 widget-content <?php if($wrong_ans > 0){?>change<?php }else{}?>">
        ...
        <div class="col-md-2 float-left">
            ...
            <div class="card mb-3 widget-content <?php if($tot_skip > 0){?>change<?php }else{}?>">

                <div class="widget-content-wrapper">

                    <div class="widget-content-left">

                        <div class="widget-heading"><h5 style="font-size: 12px;"><b>SKIPPED ANSWER</b>
            ...
            <div class="card mb-3 widget-content <?php if($tot_att > 0){ ?>change<?php }else{}?>">

                <div class="widget-content-wrapper">

                    <div class="widget-content-left">

                        <div class="widget-heading"><h5 style="font-size: 12px;"><b>ATTEMPTED ANSWER</b></h5></div>
         ...
         <div class="col-md-2 float-left">
            ...
            <div class="card mb-3 widget-content <?php if($tot_not_att > 0){?>change<?php }else{}?>">

                <div class="widget-content-wrapper">

                    <div class="widget-content-left">

                        <div class="widget-heading"><h5 style="font-size: 12px;"><b>NOT ATTEMPTED</b></h5></div>
