              ...
              <div class="card">
                <div class="card-body" style="padding: 36px;">
                  <div class="d-flex flex-column align-items-center text-center">
                    <?php if($row['image'] != ''){?>
                    <img src="<?php  printf("{$row['image']} "); ?>"class="rounded-circle" style= "object-fit: cover; height: 150px; width: 150px;">
                    <!-- <span><i name="image" id="img" class='fas fa-pencil-alt' style='font-size:24px;color:black; padding-top: 30px;'></i></span> -->
                  <?php }else{?>
                    <img src="./uploads/dummy.png" class="rounded-circle" style= "object-fit: cover; height: 150px; width: 150px;">
                    <?php } ?>
