...
<div class="app-main__inner">
    ...
    <div class="col-md-12">
                    ...
                    <div>
                        ...
                        <h5 style="padding-bottom: 5px;">Subject : <?php echo $selExam['quehead']; ?>&nbsp;&nbsp;<?php echo date('d-m-Y',strtotime($_REQUEST['date_time']))." ".$time_in_12_hour_format; ?></h5>
                    </div>
    ...
    <input type="hidden" name="src1" value="<?php echo $_GET['source']; ?>">
                ...
                if($val1 == 'menu'){?>
                    ...
                    <a href="#" class="anchr-tagcolor">Result</a><a href="#" class="anchr-tagcolor">All Results</a>
                    <a href="home.php?page=all_results&source=menu" class="anchr-tagcolor">Practice Test Result</a>
                    <a href="home.php?page=result_date&id=<?php echo $examId; ?>&source=menu"><?php echo $selExam['quehead']; ?></a>
                    <a href="#" class="anchr-tagcolor">Result</a>

                <?php }else{?>

    <a href="home.php?page=dashboard" class="anchr-tagcolor">Dashboard</a>
    <a href="home.php?page=all_results&source=dashboard" class="anchr-tagcolor">Practice Test Result</a>
    <a href="home.php?page=result_date&id=<?php echo $examId; ?>&source=dashboard"><?php echo $selExam['quehead']; ?></a>
    <a href="home.php?page=result&id=<?php echo $examId; ?>&date_time=<?php echo $date; ?>&session=<php? echo $exam_session; ?>&source=dashboard" class="anchr-tagcolor">Result</a> 
...
<?php }?>
			...
			<div class="row">
				<div class="col-md-9" style="padding: 5px;">
					<div class="col-md-12 row mb-3 float-left">

            <!-- <div class="clear-fix">&nbsp;</div> -->

            <!-- <div style="max-height:800px; overflow-y: scroll;"> -->

          <div class="main-card mb-3 card" id="main_maincard" style="padding: 0.1rem !important;     border: 0px solid #90939c;">
...
<!--   <div class="alert alert-info" style="height: 175px;
    ...
    <strong>Explanation - </strong> <?php echo $explanation; ?>
        ...
        <!-- </div> -->
				...
				<div class="col-md-3 card" style="max-height: 540px;">
                    ...
                    <div class="widget-content-right">
                        ...
                        <div class="widget-numbers">
                           ...
                           <?php
                            ...
                            ?><br><center><h4 class="col-md-12 card mb-3">Score</h4></center>
                            <!-- <div class="col-md-12"></div> -->
                            <div class="col-md-12 card mb-3" style="background-color: lightblue;">
                            <span><center>
                                <?php echo "<h3>","$ans"; echo "%","</h3>"; ?>
                                <?php //echo $score; ?><?php //echo $over,"&nbsp;&nbsp;"; ?></center></span></div>
                                
                                <div class="col-md-12"></div>

                                <div class="col-md-12 card mb-3">                           
                               <center><h5>Total Time Duration</h5></center></div>
                               <div class="col-md-12 card mb-3" style="background-color: lightblue;"> 
                                 <span><center><h6><?php echo $examtime; ?></h6></center>
                            </span> </div>
                            <div class="col-md-12"></div>
            ...
            <?php 
                             ...
                             ?>
             <div class="row mb-3">
  			<div class="col-md-2 card mb-3 <?php if($total > 0){?>change<?php }else{}?>" style="background-color: lightgrey;">
         ...
         <div class="col-md-10 card mb-3"><br>TOTAL ANSWER</div>
     </div>
         <div class="row">
         <div class="col-md-2 card mb-3 <?php if($total > 0){?>change<?php }else{ ?><?php } ?>" style="background-color: lightgrey;">
         		...
         		<a <?php if($value >0){?> href="home.php?page=result&id=<?php echo $examId;?>&date_time=<?php echo $date;?>&session=<?php echo $exam_session;?>&correct=1&source=<?php echo $val1; ?>"<?php }else{?>href=""<?php } ?>>
         			...
         			<h1><b><?php echo $value; ?></b></h1>
         			
         		</a>
         	</div>
         		<div class="col-md-10 card mb-3"><br>CORRECT ANSWER</div>
         </div>
         <div class="row">
          <div class="col-md-2 card mb-3 <?php if($tot_att > 0){?>change<?php }else{}?>" style="background-color: lightgrey;">
         	...
         	<a <?php if($tot_att >0){?>href="home.php?page=result&id=<?php echo $examId; ?>&date_time=<?php echo  $date; ?>&session=<?php echo $exam_session; ?>&filter=1&source=<?php echo $val1; ?>"<?php }else{?>href=""<?php } ?>>
         		...
         		<h1><b><?php echo $tot_att;?></b></h1>
         	</a>
         </div>
         		<div class="col-md-10 card mb-3"><br>TOTAL ATTEMPTED</div>
     </div>
     		<div class="row mb-3">
          <div class="col-md-2 card mb-3 <?php if($tot_skip > 0){?>change<?php }else{}?>" style="background-color: lightgrey;">
         	<a <?php if($tot_skip >0){?>href="home.php?page=result&id=<?php echo $examId; ?>&date_time=<?php echo  $date; ?>&session=<?php echo $exam_session;?>&filter=2&source=<?php echo $val1; ?>"<?php }else{ ?>href=""<?php }?>>
         		...
         		<h1><b><?php echo $tot_skip;  ?></b></h1>
         	</a>
         </div>
         <div class="col-md-10 card mb-3">TOTAL NOT ATTEMPTED</div>
     </div>
          <!-- <div class="col-md-12 card mb-3 <?php if($total > 0){?>change<?php }else{}?>" style="background-color: lightgrey;">
