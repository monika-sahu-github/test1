<?php
 ...
 session_start();
    ...
    $exam_session = getvalfield($conn,"exam_answers","max(exam_session)","axmne_id = '$examne_id' and sub_subjecthead_id = '$examId' and is_finel_sub = 0");
 
    $tot_skip = getvalfield($conn,"exam_answers","count(*)","axmne_id = '$examne_id' and sub_subjecthead_id = '$examId' and answer_status = 2 and YEAR(exans_created)='$y' and exam_session = '$exam_session'");
