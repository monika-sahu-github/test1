...
function get_question(que_numm,iid,selected,type){  
     ...
     hard2 = document.getElementById('hard2').value;
     cntquee = document.getElementById('cntquee').value;
    if(cntque=='' && cntquee=='ll'){
     cntque = 0;
    Swal.fire('','Please Select No. Of Question.')
...
data: "examne_id="+examne_id+"&queheadid="+queheadid+"&eqt_id="+eqt_id+"&answer="+answer+"&answers="+''+'&selected='+selected+'&cntque='+cntque+'&cntquee='+cntquee+'&type='+type+'&for_previous_id='+for_previous_id+'&cntque2='+cntque2+'&que_numm='+que_numm+'&exam_comp='+exam_comp+'&exam_id='+exam_id+'&easy='+easy+'&easy2='+easy2+'&medium='+medium+'&medium2='+medium2+'&hard='+hard+'&hard2='+hard2,
success: function(data) {
  alert(data);
dataa = data.trim();
dataArr = dataa.split("|||");
...
document.getElementById('easy2').value = easy2;
document.getElementById('medium2').value = medium2;
document.getElementById('hard2').value = hard2;
