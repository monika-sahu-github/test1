...
Swal.fire({
  ...
  title: "Congratulation! You Finished the Exam.",
  //text: "You won't to submit the Exam!",
  html: "<div><div style='color:green;'>Total Attempt - "+tot_att+"</div><div style='color:#d29706;'>Mark For Review - "+tot_skip+"</div><div style='color:red;'>Total Not Attempt - "+tot_not_att+"</div></div>",
  //text: "Total Attampt - "+tot_att+,
  type: "success",
  allowEscapeKey: false,
    allowOutsideClick: false,
